...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvWeatherDisplay = findViewById(R.id.tv_weather_data);
        // COMPLETE (3) Create an array of Strings that contain fake weather data
        String [] aWeatherData = {"Sunny", "Rain", "High Wind"};
        // COMPLETE (4) Append each String from the fake weather data array to the TextView
        for(String strWeather : aWeatherData)
        tvWeatherDisplay.append(strWeather + "\n\n\n");
    }
}